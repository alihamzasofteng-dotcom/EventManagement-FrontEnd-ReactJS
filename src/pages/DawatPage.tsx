...
import q1 from "../assets/Dawat/q1.avif";
import q2 from "../assets/Dawat/q2.avif";
import q3 from "../assets/Dawat/q3.jpg";
import q4 from "../assets/Dawat/q4.jpg";
import q5 from "../assets/Dawat/q5.jpg";
import q6 from "../assets/Dawat/q6.webp";
import q7 from "../assets/Dawat/q7.webp";
import q8 from "../assets/Dawat/q8.webp";
import q9 from "../assets/Dawat/q9.jpg";
import q10 from "../assets/Dawat/q10.jpg";
import q11 from "../assets/Dawat/q11.webp";
import q12 from "../assets/Dawat/q12.webp";
import q13 from "../assets/Dawat/q13.webp";
import q14 from "../assets/Dawat/q14.webp";
  ...
  return (
    <Box>
      ...
      <Grid
        ...
        py={10}
      >
        {[q4, q3, q10, q5, q9, q7, q8, q9, q2, q1, q12, q13].map(
          (src, index) => (
            <Image
              key={index}
              src={src}
          ...
          {[
            {
              ...
              hexColor: "purple",
              date: "10 Mar",
              heading: "Grand Dawat Celebration",
              headingBg: "purple.600",
              description:
                "Celebrate togetherness with a grand feast featuring an array of delicious dishes, vibrant decorations, and joyous moments. The perfect evening to cherish with friends and family, creating memories that last a lifetime.",
              venue: " DHA Golf Club, Pakistan",
            },
            {
              bg: "blue.100", // Darker shade reflecting the night sky
              hexColor: "blue",
              date: "30 Apr",
              heading: "Formal Dinner Dawat",
              headingBg: "blue.700",
              description:
                "Join us for an elegant Dawat evening, where culinary excellence meets the charm of a warm gathering. Enjoy a carefully curated menu and a beautifully arranged setting, perfect for creating meaningful connections.",
              venue: "Badr Banquet",
            },
            {
              bg: "green.100", // Teal color for a cool and serene night vibe
              hexColor: "green",
              date: "6 Sep",
              heading: "Traditional Dawat Night",
              headingBg: "green.700",
              description:
                "Immerse yourself in the essence of tradition with an evening filled with cultural delights, authentic cuisine, and heartfelt hospitality. A night to honor customs and bring loved ones closer together.",
              venue: "DAWAT E KHASS EVENTS MARQUEE, Lahore",
            },
          ].map((event, index) => (
            <Flex
              key={index}
